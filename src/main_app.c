                ...
                if (SDL_PointInRect(&mouse_pos, &play_rect)) {
                    ...
                    switch(current_difficulty) {
                        ...
                        case EASY:
                            ...
                            MEMOIRE_MAX = 30;
                            VITESSE_MONSTRE = 10;
                            MONSTRE_PENALITE_RAYON = 2;
                            MONSTRE_PENALITE_COUT = 20;

                            SAUT_COOLDOWN = 60*2; // Cooldown en frames
                        ...
                        case MEDIUM:
                            ...
                            SAUT_COOLDOWN = 60*5; // Cooldown en frames
                        ...
                        case HARD:
                            ...
                            MEMOIRE_MAX = 99999;
                            VITESSE_MONSTRE = 0;
                            MONSTRE_PENALITE_RAYON = 10;
                            MONSTRE_PENALITE_COUT = 25;

                            SAUT_COOLDOWN = 60*8; // Cooldown en frames
                    ...
                    // On agit en fonction du résultat
                    switch(result) {
                        case GAME_WON:
                            show_end_screen(renderer, "assets/images/congratulations.bmp");
                            break;
                        case GAME_LOST:
                            show_end_screen(renderer, "assets/images/gameover.bmp");
                            break;
