...
GameResult lancer_jeu(SDL_Renderer* rendu, int* murs_reels, int lignes, int colonnes, AudioData* audio){
    ...
    SDL_Texture* perso_texture = IMG_LoadTexture(rendu, "assets/images/CosmicLilac_AnimatedSpriteSheet.png");
    SDL_Texture* piece_texture = IMG_LoadTexture(rendu, "assets/images/o2.png");
    SDL_Texture* monstre_textures[5];
    monstre_textures[IDLE] = NULL;
    monstre_textures[DOWN] = IMG_LoadTexture(rendu, "assets/images/Carry_Run_Down-Sheet.png");
    monstre_textures[RIGHT] = IMG_LoadTexture(rendu, "assets/images/Carry_Run_Side-Sheet.png");
    monstre_textures[UP] = IMG_LoadTexture(rendu, "assets/images/Carry_Run_Up-Sheet.png");
